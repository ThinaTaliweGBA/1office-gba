...
<body id="kt_body">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <!--begin::Wrapper-->
            <div class="wrapper d-flex flex-column flex-row-fluid m-12" id="kt_wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            ...
                            <span class="text-muted mt-1 fw-semibold fs-7">See All Roles.</span>
                        </h3>
                    </div>
                            ...
                            <div class="table-responsive px-4 pb-4">
                                ...
                                @can('role create')
                                    <div class="d-print-none with-border mb-4">
                                        <a href="{{ route('role.create') }}" class="btn bg-gradient-dark ms-auto"><span
                                                class="btn-inner--icon pe-2"><i
                                                    class="material-icons">add</i></span>{{ __('Add Role') }}</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo15/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View
                    All Activities
            ...
            <div class="card-body hover-scroll-overlay-y h-400px pt-5">
                ...
                <div class="d-flex flex-stack">
                    ...
                    <div class="d-flex flex-column me-3">
                        <!--begin::Section-->
                        <div class="mb-3">
                            <a href="../../demo15/dist/apps/ecommerce/sales/details.html"
