...
<html lang="en">
  ...
  --bs-header-desktop-fixed-bg-color:  #4d4dff;     
  --bs-header-desktop-fixed-shadow: none;
  --bs-header-desktop-bottom: ;
  --bs-header-tablet-and-mobile:  #4d4dff;          
  --bs-header-tablet-and-mobile-shadow: none;
  
  --bs-aside-bg-color:   #4d4dff;                  
  --bs-aside-scrollbar-hover-color: #4b5793;
  
  --bs-page-bg: #000099;          
  --bs-app-blank-bg: #000099;    
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div id="kt_header" class="header">
						...
						<div class="container-fluid d-flex align-items-center flex-wrap justify-content-between" id="kt_header_container">
							...
							<div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-2 pb-5 pb-lg-0 pt-7 pt-lg-0" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', lg: '#kt_header_container'}">
								<!--begin::Heading-->
								<h1 class="d-flex flex-column text-dark fw-bold my-0 fs-1">Permissions List</h1>
								<!--end::Heading-->
								<!--begin::Breadcrumb-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-fluid" id="kt_content_container">
                            ...
                            <div class="test">
                                <h1>Custom Theme Preview</h1>
                            
                                <label for="bodyBg">Pick a color for the background:</label>
                                <input type="color" id="bodyBg" name="bodyBg"><br>
                            
                                <label for="buttonColor">Pick a color for the button:</label>
                                <input type="color" id="buttonColor" name="buttonColor"><br>
                            
                                <label for="textColor">Pick a color for the text:</label>
                                ...
                                <label for="buttonBorderRadius">Choose button corner style:</label>
                                ...
                                <div>
                                    ...
                                    <p>This is how your text will show.</p>
