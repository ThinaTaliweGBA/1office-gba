...
@section('row_content')
    ...
    @endphp
            ...
            <div class="col-8 card-column position-relative mb-10">
                        ...
                        <div class="card-body">
                            <form action="{{ route('resolutionhub') }}" method="GET" class="form-inline">
                                ...
                                <div class="form-group mx-sm-3 mb-2">
                                    ...
                                    <select name="sort" id="sort" class="form-control" style="height: 50%;"
            ...
            <div class="col-4 card-coloumn rounded bg-light drawer-column position-relative mb-10 shadow" id="kt_drawer_death">
    ...
    <div class="card-header">
        ...
        <div class="card-toolbar">
           <button id="hide-button" class="btn btn-icon btn-danger">X</button>
        </div>
    </div>
    <div class="card-body">
...
@push('scripts')
    <script>
        document.getElementById('hide-button').addEventListener('click', function() {
            ...
            document.querySelector('.card-column').classList.remove('col-md-8');
        ...
        document.getElementById('show-button').addEventListener('click', function() {
            ...
            document.querySelector('.card-column').classList.add('col-md-8');
